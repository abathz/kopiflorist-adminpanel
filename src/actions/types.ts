...
export const UPDATE_DATA_TRIP_PACKAGE = 'UPDATE_DATA_TRIP_PACKAGE'
...
// PICKUP METHOD
export const UPDATE_DATA_PICKUP_METHOD = 'UPDATE_DATA_PICKUP_METHOD'
export const GET_ALL_PICKUP_METHOD = 'GET_ALL_PICKUP_METHOD'

// TRANSACTION
export const UPDATE_DATA_INVOICE = 'UPDATE_DATA_INVOICE'
